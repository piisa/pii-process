"""
Command-line script to process a document, detect PII instances and produce
...
from pii_transform.api import format_policy

from .. import VERSION
from ..api import process_document
...
def parse_args(args: List[str]) -> argparse.Namespace:
    ...
    g2.add_argument("--save-pii", "--out-pii", metavar="FILENAME",
