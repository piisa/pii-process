"""
Create pii-process as a Python package
"""
...
from src.pii_process import VERSION
...
setup_args = dict(
    ...
    description="Full end-to-end processing for PII (preprocess, extract, decide, transform)",
